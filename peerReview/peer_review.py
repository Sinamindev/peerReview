...
# logic:	We use a list to store lists of assigned reviews for each peer
...
#	 		 before randomly choosing the remaining values from the deque in order to prevent two things
#			 1. Prevents ssigning a peer to themselves
...
# deque([2, 3, 4, 5, 1])									# RANGE.append(i)
